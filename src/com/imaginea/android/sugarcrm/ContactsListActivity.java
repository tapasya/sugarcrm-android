 ...
 * @author chander
 */
public class ContactsListActivity extends ListActivity implements ListView.OnScrollListener {
    ...
    void openDetailScreen(int position) {
        Intent detailIntent = new Intent(ContactsListActivity.this, ContactDetailsActivity.class);
