...
import com.imaginea.android.sugarcrm.util.SBParser;
...
public class AccountsApiTest extends RestAPITest {
	...
	public void testGetEntryList() throws Exception {
		...
		SBParser sbParser = RestUtil.getEntryList(url, mSessionId, moduleName,
				query, orderBy, offset, selectFields, linkNameToFieldsArray,
				maxResults, deleted);
		SugarBean[] sBeans = sbParser.getSBEntryList();
